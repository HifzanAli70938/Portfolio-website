    ...
    <section className="py-28">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/myPic.jpg" alt="Profile" width={120} height={120} className="rounded-full m-4 w-35 h-35 object-cover ring-2 ring-primary" />
          </motion.div>
          <motion.h1 
          ...
          >
            <motion.a
              href="https://github.com/HifzanAli70938"
              target="_blank"
            ...
            <motion.a
              href="https://www.linkedin.com/in/hifzan-ali-3a6b10271/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary transition-colors"
              whileHover={{ scale: 1.2 }}
